                                    ...
                                    <div class="panel">
                                        ...
                                        <div class="panel-body p-20">
                                            <table id="myTable" class="display table table-striped table-bordered" cellspacing="0" width="100%">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $sqM = "SELECT filiere_nom , filiere_session FROM etudiants NATURAL JOIN filieres WHERE id_etudinant =  '$id' ";
                                                    $reqM = mysqli_query($connect, $sqM);
                                                    $dtM = mysqli_fetch_object($reqM);
                                                    // $f = $_SESSION["filiere"];
                                                    // $anee = $_SESSION["id_etudiant"];
                                                    $sql = "SELECT *
                                                                        from matiere
                                                                        NATURAL JOIN filieres
                                                                        WHERE filiere_nom = '{$dtM->filiere_nom}'
                                                                        AND filiere_session='{$dtM->filiere_session}'";
                                                    ...
                                                    ?>
                                                            <tr>
                                                                ...
                                                                <td><?php echo $t["filiere_nom"] . '' . $t["filiere_session"]; ?></td>
                                                            </tr>
                                                    <?php
                                                        }
                                                    }
