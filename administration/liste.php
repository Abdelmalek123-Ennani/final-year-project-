                                ...
                                <div class="col-md-12">
                                    <div class="panel">
                                        <div class="panel-heading">
                                            ...
                                            <div class="col-md-4">
                                                <!-- <button class="btn"><a href="liste.php?i=1"> 1ere Anée</a></button>
                                                <button class="btn"><a href="liste.php?i=2">2eme Anée</a></button> -->
                                            </div>
                                            <div class="col-md-4">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <?php echo $t["date_naissance"]; ?></td><?php
                                                                                                                if ($t["continuant"] == 1) {
                                                                                                                    $bg = "green";
                                                                                                                } else if ($t["continuant"] == 2) {
                                                                                                                    $bg = "yellow";
                                                                                                                } else if ($t["continuant"] == 3) {
                                                                                                                    $bg = "red";
                                                                                                                }
                                                                                                                ?>
                                                                    ...
                                                                    <td>
                                                                        <a href="editEtudiant.php?stid=<?php echo $t["id_etudinant"]; ?>">
                                                                            <i class="fa fa-edit"></i>
                                                                        </a>
                                                                    </td>
                                                                    <td>
                                                                        <a href="operationSurEtudiant.php?delete=<?php echo $t["id_etudinant"]; ?>">
                                                                            <i class="fa fa-trash"></i>
                                                                        </a>
                                                                    </td>
                                                                    <td>
                                                                        <a href="operationSurEtudiant.php?voire=<?php echo $t["id_etudinant"]; ?>&f=<?= $filere ?>">
                                                                            <i class=" fa fa-eye"></i>
                                                                        </a>
                                                                    </td>
                                                                    <!-- <td>
                                                                        <a href="operationSurEtudiant.php?add=<?php echo $t["id_etudinant"]; ?>">
