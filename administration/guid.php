                ...
                <div class="main-page">
                    <div class="container-fluid">
                        <div class="row page-title-div">
                            <div class="col-md-6">
                                <h2 class="title">Les Absences</h2>
                            </div>
                        </div>
                                        ...
                                        <tbody>
                                            ...
                                            if (mysqli_num_rows($rep) > 0) {
                                                while ($t = mysqli_fetch_assoc($rep)) {
                                                    $sqlAbs = "SELECT SUM(nombre_heures) nbrs FROM absences WHERE etudiant_id = '{$t['id_etudinant']}'";
                                                    $reqAbs = mysqli_query($connect, $sqlAbs);
                                                    $dtAbs = mysqli_fetch_object($reqAbs);
                                            ?>
                                                    <tr>
                                                        <td><?php echo $t["id_etudinant"]; ?></td>
                                                        <td><?php echo $t["nom"]; ?></td>
                                                        <td><?php echo $t["prenom"]; ?></td>
                                                        <td><?php echo $dtAbs->nbrs ? $dtAbs->nbrs : "0"  ?></td>

                                                        <td class="text-center">
                                                            <a href="Voire.php?voire=<?php echo $t["id_etudinant"] ?>&f=<?= $filere ?>">
